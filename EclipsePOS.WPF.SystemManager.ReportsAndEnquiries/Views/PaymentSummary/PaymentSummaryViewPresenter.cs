...
{
    public class PaymentSummaryViewPresenter
    {
        private IPaymentSummaryView view;
        ...
        public PaymentSummaryViewPresenter(IUnityContainer container, IRegionManager regionManager)
        {
        ...
        public IPaymentSummaryView View
        {
            set
            {
                view = value;
        ...
        public void OnShowPaymentSummary()
        {
        ...
        private void RunReportHelper()
        {
            ...
            {
                con.Open();
                string query = "select store_name, cast( [possite].[dbo].[ufn_GetDateOnly](start_time) as varchar(12 ) ) as sales_date, sum(amount-change_amt) amt, tender_desc " +
                                ...
                                "and trans_tender.store_no = trans.store_no  ) " +
                                ...
                                "group by store_name, tender_desc, cast( [possite].[dbo].[ufn_GetDateOnly](start_time) as varchar(12 ) ) " +
                                "order by store_name, tender_desc, sales_date ";
                ...
                ReportData rData = DataEngine.Load(dataReader, new string[] { "store_name", "tender_desc" });
                ReportDefinition rDef = new ReportDefinition();
                rDef.ReportName = "PaymentSummary";

                rDef.Page.Margin = new Size(40, 70);
                //Header definition
                rDef.HeaderTemplate = "<Section><Paragraph TextAlignment=\"Center\" FontWeight=\"Bold\" FontSize=\"12\">Payment Summary Report</Paragraph></Section>";
                ...
                //Footer definition
                rDef.FooterTemplate = "<Section><Paragraph TextAlignment=\"Center\" FontSize=\"12\">*** End of Payment Summary Report ***</Paragraph></Section>";
                ...
                def1.HeaderTemplate = "<TableRowGroup>" +
                                        ...
                                        "<TableRow>" +
                                              "<TableCell>" +
                                              "<Paragraph FontWeight=\"Bold\" FontSize=\"12\">Sales Date</Paragraph>" +
                                            "</TableCell>" +
                    //        "<TableCell>" +
                    //          "<Paragraph FontWeight=\"Bold\" FontSize=\"12\">Payment Type</Paragraph>" +
                    //        "</TableCell>" +
                                            "<TableCell>" +
                                                "<Paragraph FontWeight=\"Bold\" FontSize=\"12\">Payment Amount</Paragraph>" +
                                            "</TableCell>" +
                                         "</TableRow>" +
                                    "</TableRowGroup>";
                ...
                def1.FooterTemplate = "<TableRowGroup > " +
                    ...
                    //      "</TableCell>" +
                                                "<TableCell>" +
                                                    "<Paragraph TextAlignment=\"Left\" FontWeight=\"Bold\" FontSize=\"12\">" +
                                                        "<c:FormattedRun PropertyName=\"amt\"/>" +
                                                    "</Paragraph>" +
                                                "</TableCell>" +
                                               "</TableRow>" +
