...
{
    public class SalesPersonPresenter
    {
        ISalesPersonView _view;
        ...
        private EclipsePOS.WPF.SystemManager.Data.employeeDataSet emplyeeData;
        ...
        public SalesPersonPresenter(IUnityContainer container, IRegionManager regionManager)
        {
        ...
        private void RunReportHelper()
        {
            ...
            {
                con.Open();
                string query = "select store_name,  trans_sales_person.employee_no as emp, employee.fname, " +
                   "cast( [possite].[dbo].[ufn_GetDateOnly](start_time) as varchar(12 ) ) as sales_date,  " +   
                   "[possite].[dbo].[ufn_Addition](sum(ext_amount), sum(promo.amt) ) as net_sales " +
                   ...
                   "left  outer join " +
                   "trans_sales_person " +
                   "on (trans.organization_no=trans_sales_person.organization_no and trans.store_no = trans_sales_person.store_no and trans.trans_no=trans_sales_person.trans_no and trans.pos_no = trans_sales_person.pos_no) " +
                   "left outer join " +
                   ...
                   "(trans_sales_person.organization_no = employee.organization_no and trans_sales_person.employee_no = employee.employee_no) " +
                   "where trans.state = 2 " +
                   ...
                   " and trans_sales_person.employee_no >= @employeeFrom and trans_sales_person.employee_no <= @employeeTo " +
                   " group by store_name, trans_sales_person.employee_no, employee.fname, " +
                   " [possite].[dbo].[ufn_GetDateOnly](start_time) " +
                   " order by store_name, trans_sales_person.employee_no, [possite].[dbo].[ufn_GetDateOnly](start_time) ";
                ...
                comm.Parameters.Add("@employeeFrom", SqlDbType.Char).Value = View.EmployeeFrom;
                comm.Parameters.Add("@employeeTo", SqlDbType.Char).Value = View.EmployeeTo;
                ...
                rDef.ItemTemplate = "<TableRow>" +
                                        "<TableCell BorderThickness=\"0,0,0,0\" BorderBrush=\"Black\" >" +
                                            "<Paragraph FontSize=\"12\"  TextAlignment=\"Center\" >" +
                                                "<c:FormattedRun PropertyName=\"emp\"/>" +
                                            "</Paragraph>" +
                                        "</TableCell>" +
                                         "<TableCell BorderThickness=\"0,0,0,0\" BorderBrush=\"Black\"  >" +
                                            "<Paragraph FontSize=\"12\"  TextAlignment=\"Center\" >" +
                                                "<c:FormattedRun PropertyName=\"fname\"/>" +
                                            "</Paragraph>" +
                                        "</TableCell>" +
                                         "<TableCell BorderThickness=\"0,0,0,0\" BorderBrush=\"Black\"  >" +
                                            "<Paragraph FontSize=\"12\"  TextAlignment=\"Center\" >" +
                ...
                def1.HeaderTemplate = "<TableRowGroup>" +
                                        ...
                                        "<TableRow>" +
                                            "<TableCell BorderThickness=\"0,0,0,0\" BorderBrush=\"Black\" >" +
                                                "<Paragraph FontWeight=\"Bold\" FontSize=\"12\" TextAlignment=\"Center\">Employee ID</Paragraph>" +
                                            "</TableCell>" +
                                            "<TableCell BorderThickness=\"0,0,0,0\" BorderBrush=\"Black\">" +
                                                "<Paragraph FontWeight=\"Bold\" FontSize=\"12\" TextAlignment=\"Center\" >Name</Paragraph>" +
                                            "</TableCell>" +
                                            "<TableCell BorderThickness=\"0,0,0,0\" BorderBrush=\"Black\">" +
