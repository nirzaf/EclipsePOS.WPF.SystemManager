...
namespace EclipsePOS.WPF.SystemManager.Data {
    ...
    public partial class DepartmentDataSet : global::System.Data.DataSet {
        ...
        public partial class departmentDataTable : global::System.Data.TypedTableBase<departmentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public departmentRow AdddepartmentRow(string organization_no, string department_id, string department_name) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public departmentRow FindByorganization_nodepartment_id(string organization_no, string department_id) {
        ...
        public partial class departmentRow : global::System.Data.DataRow {
            ...
            public string organization_no {
                get {
                    return ((string)(this[this.tabledepartment.organization_noColumn]));
                }
                set {
                    this[this.tabledepartment.organization_noColumn] = value;
                }
            }
...
namespace EclipsePOS.WPF.SystemManager.Data.DepartmentDataSetTableAdapters {
    ...
    public partial class departmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[department] WHERE (([organization_no] = @Original_organization" +
                "_no) AND ([department_id] = @Original_department_id) AND ([department_name] = @O" +
                "riginal_department_name))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[department] ([organization_no], [department_id], [department_name]) VALUES (@organization_no, @department_id, @department_name);
SELECT organization_no, department_id, department_name FROM department WHERE (department_id = @department_id) AND (organization_no = @organization_no)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[department] SET [organization_no] = @organization_no, [department_id] = @department_id, [department_name] = @department_name WHERE (([organization_no] = @Original_organization_no) AND ([department_id] = @Original_department_id) AND ([department_name] = @Original_department_name));
SELECT organization_no, department_id, department_name FROM department WHERE (department_id = @department_id) AND (organization_no = @organization_no)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT organization_no, department_id, department_name FROM dbo.department";
        ...
        public virtual int Delete(string Original_organization_no, string Original_department_id, string Original_department_name) {
            ...
            if ((Original_department_id == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_department_id));
            }
        ...
        public virtual int Insert(string organization_no, string department_id, string department_name) {
        ...
        public virtual int Update(string organization_no, string department_id, string department_name, string Original_organization_no, string Original_department_id, string Original_department_name) {
            if ((organization_no == null)) {
                throw new global::System.ArgumentNullException("organization_no");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string department_name, string Original_organization_no, string Original_department_id, string Original_department_name) {
            return this.Update(Original_organization_no, Original_department_id, department_name, Original_organization_no, Original_department_id, Original_department_name);
        }
    }
