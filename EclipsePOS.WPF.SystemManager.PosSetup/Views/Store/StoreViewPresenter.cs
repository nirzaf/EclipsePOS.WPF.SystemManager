...
{
    public class StoreViewPresenter
    {
        ...
        private EclipsePOS.WPF.SystemManager.Data.storeDataSetTableAdapters.TableAdapterManager taManager = new EclipsePOS.WPF.SystemManager.Data.storeDataSetTableAdapters.TableAdapterManager();
        ...
        public void OnShowStore()
        {
            ...
            _colView = CollectionViewSource.GetDefaultView(storeData.retail_store) as CollectionView;
            taManager.retail_storeTableAdapter = storeTa;
        ...
        public void OnAddCommandExecute(object obj)
        {
            if (!storeData.HasErrors)
            {
                ...
                EclipsePOS.WPF.SystemManager.Data.storeDataSet.retail_storeRow  dataRow = storeData.retail_store.Newretail_storeRow();
                ...
                storeData.retail_store.Addretail_storeRow(dataRow);
        ...
        public void OnSaveCommandExecute(object obj)
        {
            ...
            else
            {
                try
                {
                    if (storeData.HasChanges())
                    {
                        if (taManager.UpdateAll(storeData) > 0)
                        {
        ...
        public void FilterCustomerByOrganizationNo(string organizationNo)
        {
            ...
            BindingListCollectionView view1 = CollectionViewSource.GetDefaultView(this.customerData.customer) as BindingListCollectionView;
